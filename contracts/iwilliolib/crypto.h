 ...
 *  iwillio::print("sha256 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  iwillio::print("sha1 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  iwillio::print("sha512 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  iwillio::print("ripemod160 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  iwill_assert( calc_hash == hash, "invalid hash" );
 *  @endcode
 */
 ...
 *  iwillio::print("pub key matches the pub key generated from digest");
 *  @endcode
 */
