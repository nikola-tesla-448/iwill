   ...
   class optional {
      public:
         ...
         */
          ...
          */
         T&       operator*()      { iwillio_assert(_valid, "dereference of empty optional"); return ref(); }
          ...
          * @return T& - Contained value
          */
         const T& operator*()const { iwillio_assert(_valid, "dereference of empty optional"); return ref(); }
         ...
         T*       operator->()
         {
            iwillio_assert(_valid, "dereference of empty optional");
            return ptr();
         }
         ...
         *  @return iwillio::datastream<Stream>& - Reference to the datastream
         */
         template<typename Stream>
         friend inline iwillio::datastream<Stream>& operator>> (iwillio::datastream<Stream>& ds, optional& op)
         {
            char valid = 0;
            ds >> valid;
            if (valid) {
         ...
         */
         template<typename Stream>
         friend inline iwillio::datastream<Stream>& operator<< (iwillio::datastream<Stream>& ds, const optional& op)
         {
