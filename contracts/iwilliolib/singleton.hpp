...
namespace  iwillio {
    ...
    *  @brief Defines IWILLIO Singleton Table
    *  @ingroup databasecpp 
    *  @{
    */
   ...
   class singleton
   {
      ...
      struct row {
         ...
         IWILLLIB_SERIALIZE( row, (value) )
      };

      typedef iwillio::multi_index<SingletonName, row> table;
      ...
      public:
         ...
         T get() {
            ...
            iwillio_assert( itr != _t.end(), "singleton does not exist" );
            return itr->value;
         }
