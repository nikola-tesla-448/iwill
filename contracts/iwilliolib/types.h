...
/**
 * @brief IWILLIO Public Key
 * @details IWILLIO Public Key. It is 34 bytes.
 */
struct public_key {
   char data[34];
};
...
/**
 * @brief IWILLIO Signature
 * @details IWILLIO Signature. It is 66 bytes.
 */
struct signature {
   uint8_t data[66];
};
...
/**
 * @brief Type of IWILLIO Transaction Id
 * @details Type of IWILLIO Transaction Id. It is 256-bit hash
 */
