 ...
 * @ingroup types
 * @brief Defines contract type which is %base class for every IWILLIO contract
 * 
 * @{
 * 
 */
...
/**
 * @brief %Base class for IWILLIO contract.
 * @details %Base class for IWILLIO contract. %A new contract should derive from this class, so it can make use of IWILLIO_ABI macro.
 */
class contract {
   public:
      /**
