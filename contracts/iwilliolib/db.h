 ...
 *  @brief Defines an interface to IWILLIO database
 *  @ingroup database
 *
 *  @details
 *  IWILLIO organizes data according to the following broad structure:
 ...
 *  @ingroup database
 *
 *  @details Database C API provides low level interface to IWILLIO database.
 *
...
/**
  ...
  *  iwillio_assert(itr >= 0, "Alice cannot be removed since she was already not found in the table");
  *  db_remove_i64(itr);
  *  @endcode
  */
...
/**
  ...
  *  iwillio_assert(len <= 50, "buffer to small to store retrieved record");
...
/**
  ...
  *  iwillio_assert(end_itr < -1, "Charlie was not the last entry in the table");
  *  @endcode
  */
