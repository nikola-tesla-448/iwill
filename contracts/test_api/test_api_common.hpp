...
#ifdef DISABLE_IWILLLIB_SERIALIZE
#include <iwilliolib/serialize.hpp>
#undef IWILLLIB_SERIALIZE
#define IWILLLIB_SERIALIZE(...)
#endif
...
struct u128_action {
  ...
  IWILLLIB_SERIALIZE( u128_action, (values) )
};
...
struct cf_action {
   ...
   IWILLLIB_SERIALIZE( cf_action, (payload)(cfd_idx) )
};
...
struct dtt_action {
   ...
   IWILLLIB_SERIALIZE( dtt_action, (payer)(deferred_account)(deferred_action)(permission_name)(delay_sec) )
};
...
struct invalid_access_action {
   ...
   IWILLLIB_SERIALIZE( invalid_access_action, (code)(val)(index)(store) )
};
