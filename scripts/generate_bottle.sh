...
mkdir -p ${PROJECT}/${VERSION}/opt/iwillio/lib/cmake
...
echo "class Iwillio < Formula

   homepage \"${URL}\"
   revision 0
   url \"https://github.com/iwillio/iwill/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/iwillio/iwill/releases/download/v${VERSION}\"
