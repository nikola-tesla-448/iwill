...
def main():
    if len(sys.argv) == 1:
        print('Please specify an operation of export or import: ./ricardiwill.py <import|export>')
        sys.exit(1)

    if sys.argv[1] == 'import':
        if len(sys.argv) != 4:
            print('Please specify a source and destination abi:')
            print('Usage: ./ricardiwill.py import /iwill/contracts/contract/mycontract.abi /iwill/contracts/contract/withricardian-mycontract.abi')
        ...
        if len(sys.argv) != 3:
            ...
            print('Usage: ./ricardiwill.py export /iwill/contracts/contract/mycontract.abi')
