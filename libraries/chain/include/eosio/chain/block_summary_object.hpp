...
CHAINBASE_SET_INDEX_TYPE(iwillio::chain::block_summary_object, iwillio::chain::block_summary_multi_index)

FC_REFLECT( iwillio::chain::block_summary_object, (block_id) )
