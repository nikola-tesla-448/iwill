...
CHAINBASE_SET_INDEX_TYPE(iwillio::chain::permission_link_object, iwillio::chain::permission_link_index)

FC_REFLECT(iwillio::chain::permission_link_object, (account)(code)(message_type)(required_permission))
