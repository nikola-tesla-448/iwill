...
CHAINBASE_SET_INDEX_TYPE(iwillio::chain::transaction_object, iwillio::chain::transaction_multi_index)

FC_REFLECT(iwillio::chain::transaction_object, (expiration)(trx_id))
