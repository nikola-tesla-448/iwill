...
CHAINBASE_SET_INDEX_TYPE(iwillio::chain::permission_object, iwillio::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(iwillio::chain::permission_usage_object, iwillio::chain::permission_usage_index)

FC_REFLECT(iwillio::chain::permission_object, (usage_id)(parent)(owner)(name)(last_updated)(auth))
FC_REFLECT(iwillio::chain::snapshot_permission_object, (parent)(owner)(name)(last_updated)(last_used)(auth))

FC_REFLECT(iwillio::chain::permission_usage_object, (last_used))
