...
using action_name    = iwillio::chain::action_name;
...
FC_REFLECT( iwillio::chain::newaccount                       , (creator)(name)(owner)(active) )
FC_REFLECT( iwillio::chain::setcode                          , (account)(vmtype)(vmversion)(code) )
FC_REFLECT( iwillio::chain::setabi                           , (account)(abi) )
FC_REFLECT( iwillio::chain::updateauth                       , (account)(permission)(parent)(auth) )
FC_REFLECT( iwillio::chain::deleteauth                       , (account)(permission) )
FC_REFLECT( iwillio::chain::linkauth                         , (account)(code)(type)(requirement) )
FC_REFLECT( iwillio::chain::unlinkauth                       , (account)(code)(type) )
FC_REFLECT( iwillio::chain::canceldelay                      , (canceling_auth)(trx_id) )
FC_REFLECT( iwillio::chain::onerror                          , (sender_id)(sent_trx) )
