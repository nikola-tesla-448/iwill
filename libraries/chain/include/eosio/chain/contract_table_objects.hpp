...
#include <iwillio/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(iwillio::chain::table_id_object, iwillio::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(iwillio::chain::key_value_object, iwillio::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(iwillio::chain::index64_object, iwillio::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(iwillio::chain::index128_object, iwillio::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(iwillio::chain::index256_object, iwillio::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(iwillio::chain::index_double_object, iwillio::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(iwillio::chain::index_long_double_object, iwillio::chain::index_long_double_index)

FC_REFLECT(iwillio::chain::table_id_object, (code)(scope)(table)(payer)(count) )
FC_REFLECT(iwillio::chain::key_value_object, (primary_key)(payer)(value) )

#define REFLECT_SECONDARY(type)\
  FC_REFLECT(type, (primary_key)(payer)(secondary_key) )

REFLECT_SECONDARY(iwillio::chain::index64_object)
REFLECT_SECONDARY(iwillio::chain::index128_object)
REFLECT_SECONDARY(iwillio::chain::index256_object)
REFLECT_SECONDARY(iwillio::chain::index_double_object)
REFLECT_SECONDARY(iwillio::chain::index_long_double_object)
