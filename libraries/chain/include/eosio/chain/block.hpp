#pragma once
#include <iwillio/chain/block_header.hpp>
...
FC_REFLECT_ENUM( iwillio::chain::transaction_receipt::status_enum,
                 (executed)(soft_fail)(hard_fail)(delayed)(expired) )

FC_REFLECT(iwillio::chain::transaction_receipt_header, (status)(cpu_usage_us)(net_usage_words) )
FC_REFLECT_DERIVED(iwillio::chain::transaction_receipt, (iwillio::chain::transaction_receipt_header), (trx) )
FC_REFLECT_DERIVED(iwillio::chain::signed_block, (iwillio::chain::signed_block_header), (transactions)(block_extensions) )
