...
#include <iwillio/chain/incremental_merkle.hpp>
...
CHAINBASE_SET_INDEX_TYPE(iwillio::chain::global_property_object, iwillio::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(iwillio::chain::dynamic_global_property_object,
                         iwillio::chain::dynamic_global_property_multi_index)

FC_REFLECT(iwillio::chain::dynamic_global_property_object,
           (global_action_sequence)
          )

FC_REFLECT(iwillio::chain::global_property_object,
