...
CHAINBASE_SET_INDEX_TYPE(iwillio::chain::producer_object, iwillio::chain::producer_multi_index)

FC_REFLECT(iwillio::chain::producer_object::id_type, (_id))
FC_REFLECT(iwillio::chain::producer_object, (id)(owner)(last_aslot)(signing_key)(total_missed)(last_confirmed_block_num)
           (configuration))
