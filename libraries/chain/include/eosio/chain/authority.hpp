...
FC_REFLECT(iwillio::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(iwillio::chain::key_weight, (key)(weight) )
FC_REFLECT(iwillio::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(iwillio::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(iwillio::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
