...
CHAINBASE_SET_INDEX_TYPE( iwillio::account_control_history_object, iwillio::account_control_history_multi_index )

FC_REFLECT( iwillio::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
