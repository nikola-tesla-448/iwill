...
CHAINBASE_SET_INDEX_TYPE( iwillio::public_key_history_object, iwillio::public_key_history_multi_index )

FC_REFLECT( iwillio::public_key_history_object, (public_key)(name)(permission) )
